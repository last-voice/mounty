...
L["options.Dragon"] = "Dragonflight mode - Always prefer dragons for flying"
...
L["why.long.dragonflight.no"] = "Too sad, this area is |hnot for Dragonflight|r."
L["why.long.dragonflight.use"] = "Let's try to call a |hdragon|r, then."
L["why.long.dragonflight.empty"] = "But it will not happen, since you don't seem to have assigned them, yet."
...
L["why.long.fly.use.dragon"] = "Since you prefer |hDragonflight mounts|r, here it comes."
...
L["why.short.fly.use.dragon"] = "Dragonflight mounts prefered"
