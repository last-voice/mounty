...
L["why.long.repair.no"] = "Deine |hRüstung ist ok|r. Das Reparier-Mount bleibt im Stall."
...
L["why.long.usable.all"] = "|hAlle deine %s|r sind hier und jetzt nutzbar."
L["why.long.usable.some"] = "|h%s von deinen %s|r sind hier und jetzt nutzen."
L["why.long.usable.none"] = "Doch |hkeins|r deiner %s ist gerade nutzbar."
