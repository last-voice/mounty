...
L["options.Look"] = "Protz-Modus - Protzerei in Ruhebereichen (außerhalb von Dragonflight)"
...
L["why.long.usable.some"] = "|h%s von deinen %s|r sind hier und jetzt nutzbar."
...
L["why.long.picked"] = "Hier ist dein Mount: |h%s|r. Festhalten!"
