...
L["options.Why"] = "Warum-Modus - Auswahl immer im Chat erklären"
L["options.WhyShort"] = "Kürzere Erklärung"
L["options.Random"] = "Zufalls-Modus - Zufällig anstatt eins nach dem anderen"
L["options.Look"] = "Protz-Modus - In Ruhebereichen (außerhalb von Dragonflight) mit Protz-Mounts protzen"
...
L["why.long.repair.no"] = "Deine |hRüstung ist ok|r."
...
L["why.long.taxi.no1"] = "Du bist |halleine unterwegs|r, ein Taxi rufen wir also nicht."
...
L["why.long.usable.all"] = "|hAlle %s|r davon sind hier und jetzt nutzbar."
L["why.long.usable.some"] = "Hier und jetzt kannst du |h%s deiner %s|r davon nutzen."
L["why.long.usable.none"] = "Davon ist hier |hkeines|r aus guten Gründen nutzbar."
