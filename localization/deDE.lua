...
BINDING_NAME_MOUNTY_SKYRIDING = "Skyriding"
...
L["options.Look"] = "Protz-Modus - Protzerei in Ruhebereichen"
...
L["why.long.only.flyable"] = "Und weil du hier |hfliegen|r kannst, gibt es auch eines mit Flügeln."
L["why.long.fly.any"] = "Lass uns abheben, du |hkannst hier fliegen|r."
L["why.long.fly.none"] = "Hier und jetzt ist |hFliegen keine Option|r für dich."
...
L["why.long.fly.prefer.skyriding"] = "Du ziehst Skyriding vor."
L["why.long.fly.prefer.normal"] = "Du fliegst lieber die guten Alten."
L["why.long.fly.use"] = "Hier kommt also dein |hFlug-Mount|r."
L["why.long.fly.empty"] = "Wenn du in Mounty #TLV eines zugewiesen hättest."
L["why.long.fly.skyriding.use"] = "Dann wollen wir mal den |hHimmel reiten|r."
L["why.long.fly.skyriding.empty"] = "Wenn denn einer da wäre, wenn du schon einen zugewiesen hättest."
...
L["why.long.usable.none.fly"] = "Doch |hkeins der %s|r ist ein nutzbares Flug-Mount."
...
L["why.short.only.flyable"] = "nur fliegende Mounts"
L["why.short.fly.any"] = "Flugbereich"
L["why.short.fly.none"] = "kein Flugbereich"
...
L["why.short.fly.prefer.skyriding"] = "Skyriding bevorzugt"
L["why.short.fly.prefer.normal"] = "lieber normal fliegen"
L["why.short.fly.use"] = "rufe Flug-Mount"
L["why.short.fly.empty"] = "nix zugewiesen"
L["why.short.fly.skyriding.use"] = "Skyriding-Mount kommt"
L["why.short.fly.skyriding.empty"] = "nix zugewiesen"
...
L["why.short.usable.none.fly"] = "kein nutzbares Flug-Mount unter den %s"
...
/mounty magic|dskyriding|dfly|dground|drandom|drepair|dshowoff|dtaxi|dwater
...
L["upgrade.popup"] = "v3.0.0!\n\nMount #TLV sollte nun wieder einen weitestgehend ordentlichen Job machen.\n\n--° -°° °°° °.° ..° ... °.. °.° °°° °°- °--\n\nKleine Spenden sind willkommen. Siehe README."
